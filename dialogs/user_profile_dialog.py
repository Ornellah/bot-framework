...
class UserProfileDialog(ComponentDialog):
    ...
    async def city_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        return await step_context.prompt(
            TextPrompt.__name__,
            PromptOptions(
                prompt=MessageFactory.text("Please enter your favorite city.")
            ),
        )
    ...
    async def summary_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if step_context.result:
            ...
            msg = f"I have your mode of transport as {user_profile.transport}, your name as {user_profile.name} and you favorite city is {user_profile.city}."
